...
export default function RegisterPage() {
  ...
  return (
    <Layout
      title="Créer un compte | NOVIS Coworking"
      description="Créez votre compte NOVIS Coworking pour réserver des espaces de travail et rejoindre notre communauté."
    >
